      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="mt-4">
          <button
            ...
            className="group inline-flex items-center gap-2 px-8 py-4 bg-lime-600 hover:bg-lime-700 text-white font-bold text-lg rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-lime-500/20"
          >
            Enroll Now
